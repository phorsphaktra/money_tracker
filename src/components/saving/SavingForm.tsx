      ...
      <form onSubmit={handleFormSubmit} className="space-y-4 sm:space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4">
          <button
            ...
            className={`flex items-center justify-center gap-2 px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl border 
        ...
        <div className="space-y-1 sm:space-y-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-8 pr-4 py-2.5 sm:py-3 rounded-xl border border-gray-300 
        ...
        <div className="space-y-1 sm:space-y-2">
          ...
          <textarea
            ...
            className="w-full px-4 py-2.5 sm:py-3 rounded-xl border border-gray-300 
              focus:ring-2 focus:ring-indigo-500 focus:border-transparent
              dark:bg-gray-800 dark:border-gray-700 transition-all duration-200
              hover:border-indigo-300 resize-none min-h-[88px] touch-manipulation"
            rows={2}
        ...
        {/* Action Buttons */}
        <div className="flex flex-col-reverse sm:flex-row gap-3 sm:gap-2 mt-6 sm:mt-8">
          <Button
            variant="secondary"
            onClick={onCancel}
